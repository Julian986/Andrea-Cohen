...
const testimonios: Testimonio[] = [
	{
		nombre: 'María S.',
		texto: 'Gracias a Andrea logré controlar mi diabetes con una alimentación saludable. Su profesionalismo y paciencia son excepcionales.',
		rating: 5,
		fecha: 'Nov 2024',
		fuente: 'Google',
	...
	{
		nombre: 'Carlos R.',
		texto: 'Como deportista, el plan nutricional de Andrea mejoró mi rendimiento significativamente. Muy recomendable.',
		rating: 5,
		fecha: 'Oct 2024',
		fuente: 'Google',
	...
	{
		nombre: 'Elena M.',
		texto: 'El acompañamiento nutricional fue excelente. Perdí peso de forma saludable y aprendí a comer mejor.',
		rating: 5,
		fecha: 'Sep 2024',
		fuente: 'Doctoralia',
	...
	{
		nombre: 'Roberto J.',
		texto: 'Mi hijo mejoró mucho su alimentación gracias a Andrea. Excelente atención y muy didáctica.',
		rating: 5,
		fecha: 'Ago 2024',
		fuente: 'Google',
		avatar: 'https://res.cloudinary.com/dzoupwn0e/image/upload/v1753711316/photo-1500648767791-00dcc994a43e_alwlur.webp',
	...
	{
		nombre: 'Lucía P.',
		texto: 'Mi transición al vegetarianismo fue mucho más fácil con la guía de Andrea. Muy profesional.',
		rating: 5,
		fecha: 'Jul 2024',
		fuente: 'Doctoralia',
		avatar: 'https://res.cloudinary.com/dzoupwn0e/image/upload/v1753711317/photo-1544005313-94ddf0286df2_qicg9u.webp',
	...
	{
		nombre: 'Diego F.',
		texto: 'Excelente nutricionista. Me ayudó a mejorar mis hábitos alimentarios y mi salud general.',
		rating: 5,
		fecha: 'Jun 2024',
		fuente: 'Google',
		avatar: 'https://res.cloudinary.com/dzoupwn0e/image/upload/v1755631766/photo-1502685104226-ee32379fefbe_dc6oxf.webp',
  ...
  return (
    <section id="testimonios" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-slate-600 text-center max-w-2xl mx-auto">Lo que dicen mis pacientes sobre las consultas nutricionales.</p>
        ...
        <div className="mt-8 text-center">
          <a href="#contacto" className="inline-block text-emerald-600 font-medium hover:underline">Ver más testimonios</a>
        </div>
      </div>
    </section>
  )
