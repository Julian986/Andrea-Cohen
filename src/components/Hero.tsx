      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            {/* Badge profesional */}
            <div className="inline-flex items-center px-4 py-2 border border-emerald-200 rounded-full text-emerald-700 text-sm font-medium">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-800 leading-tight">
                Lic. Andrea
                <span className="block text-emerald-600">Cohen</span>
          </h1>
            ...
            <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
              Te acompaño en tu proceso de alimentación saludable con 
              planes nutricionales personalizados, educación alimentaria y un enfoque 
              integral centrado en tus objetivos de salud.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 py-6">
              <div className="flex items-start gap-3 justify-center sm:justify-start">
                ...
                <div className="flex-1 text-left sm:text-left sm:flex-initial">
              ...
              <div className="flex items-start gap-3 justify-center sm:justify-start">
                ...
                <div className="flex-1 text-left sm:text-left sm:flex-initial">
                  ...
                  <p className="text-sm text-slate-600">Lun a Vie: 8:00 - 18:00</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="https://wa.me/5491149358861?text=Hola%20Andrea%2C%20quiero%20agendar%20una%20consulta" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center justify-center px-6 py-3 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 duration-200"
              >
              ...
              <a 
                href="#servicios" 
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-emerald-600 text-emerald-600 font-semibold rounded-lg hover:bg-white transition-colors"
              >
                Conocer Servicios
              </a>
            </div>
          ...
          <div className="relative">
            <div className="relative max-w-md mx-auto">
              {/* Imagen principal con diseño limpio */}
              <div className="relative">
                <img 
                  className="w-full object-cover rounded-2xl shadow-2xl" 
                  src="https://res.cloudinary.com/dzoupwn0e/image/upload/v1757264729/foto_perfil_1_xnmhk2.webp"
                  alt="Retrato profesional de Andrea Cohen, nutricionista especializada en nutrición clínica" 
                />
